...
- **MEDIUM:** Define interfaces in the _consumer_ package, not the _implementer_ package. Go's implicit interface satisfaction makes this idiomatic and avoids circular imports.
