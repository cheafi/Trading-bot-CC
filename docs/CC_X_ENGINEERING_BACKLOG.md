...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **P0** (shipped) | `autonomous_learning_loop.py`; `GET /api/v7/meta-intelligence/summary`; `POST /api/v7/learning-loop/run`; ai_usage in usage summary; scheduler 4:50 PM observe/calibrate/propose; Sunday weekly IC cache | Tier 1 fully automated                      | **Q1** Know: forward marks + usage counts · **Q2** Believe: belief queue due count · **Q3** Doubt: Brier drift flag · **Q4** Act: explicit `may_authorize_deploy: false` |
