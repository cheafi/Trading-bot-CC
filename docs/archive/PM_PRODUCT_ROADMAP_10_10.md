...
**Master developer prompt（Alpha Operating System · 四 Sprint · 可直接 copy 開工）：**  
[`docs/ALPHA_OPERATING_SYSTEM_DEVELOPER_PROMPT_ZH.md`](./ALPHA_OPERATING_SYSTEM_DEVELOPER_PROMPT_ZH.md)
