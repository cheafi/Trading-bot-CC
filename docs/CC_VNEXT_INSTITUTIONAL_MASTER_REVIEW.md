...
| **Analogs** | *v3 new* | Pattern match set | Research tab only |
...
**Target:** Allocator-grade book view that answers: *What do I own, what risk am I running, what should I trim/add, and does a new name fit?* — all subordinate to page gates.
...
*End of CC vNext Institutional Alpha OS Master Review.*
