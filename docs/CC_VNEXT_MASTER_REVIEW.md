...
CC vNext should aim to be: **“Institutional-grade operator discipline on retail-accessible infrastructure”** — the Palantir-*shaped* decision layer for a single PM or small pod, with Bloomberg/FactSet as complementary data sources, not replacements.
...
*End of master review. No code changes were made except this document.*
