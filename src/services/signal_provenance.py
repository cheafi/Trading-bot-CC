...
SIGNAL_CC_TRACKER_WAVE = "cc_tracker_wave"
SIGNAL_SAFE_AUTOMATION = "safe_automation"
SIGNAL_CC_OPERATING_SYSTEM = "cc_operating_system"
...
_SIGNAL_AUTHORITY_CEILING: Dict[str, str] = {
    ...
    SIGNAL_CC_TRACKER_WAVE: AUTHORITY_CONFIRMATION,
    SIGNAL_SAFE_AUTOMATION: AUTHORITY_CONFIRMATION,
    SIGNAL_CC_OPERATING_SYSTEM: AUTHORITY_CONFIRMATION,
}
...
_SIGNAL_RULES: Dict[str, Dict[str, Any]] = {
    ...
    SIGNAL_CC_TRACKER_WAVE: {
        "label": "CC tracker wave console",
        "lag_disclosure": "Aggregated tracker state — context and monitor support",
        "may_authorize_deploy": False,
        "may_upgrade_tradeability": False,
        "monitor_only": True,
    },
    SIGNAL_SAFE_AUTOMATION: {
        "label": "Safe automation support",
        "lag_disclosure": "Workflow hints — operator must confirm on deploy surfaces",
        "may_authorize_deploy": False,
        "may_upgrade_tradeability": False,
        "monitor_only": True,
    },
    SIGNAL_CC_OPERATING_SYSTEM: {
        "label": "CC operating system bundle",
        "lag_disclosure": "Multi-module operator intelligence — monitor/ops/allocator support",
        "may_authorize_deploy": False,
        "may_upgrade_tradeability": False,
        "monitor_only": True,
    },
