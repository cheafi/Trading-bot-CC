...
class MomentumBreakoutStrategy(IStrategy):
    ...
    def populate_indicators(
        ...
        dataframe["macd_hist_rising"] = dataframe["macd_hist"] > dataframe[
            "macd_hist"
        ].shift(1)
        ...
        dataframe["recent_high"] = (
            dataframe["high"].rolling(self.breakout_lookback).max()
        )
        ...
        # Trend conditions
        dataframe["uptrend"] = (dataframe["close"] > dataframe["ema_20"]) & (
