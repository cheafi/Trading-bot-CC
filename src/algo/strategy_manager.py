                    ...
                    try:
                        ...
                        for name in dir(submodule):
                            ...
                            if (
                                ...
                                and obj.STRATEGY_ID != "base_strategy"
                            ):
                                cls.register(obj)
...
class StrategyManager:
    ...
    def load_strategy(
        self, strategy_id: str, config: Optional[StrategyConfig] = None
    ) -> Optional[IStrategy]:
        """
    ...
    def run_strategy(
        self, strategy_id: str, dataframe: pd.DataFrame, metadata: Dict[str, Any]
    ) -> pd.DataFrame:
        """
    ...
    def run_all_strategies(
        self, dataframe: pd.DataFrame, metadata: Dict[str, Any], aggregate: bool = True
