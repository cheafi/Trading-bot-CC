...
try:
    from src.api.routers.cc_replay import router as cc_replay_router

    app.include_router(cc_replay_router)
except Exception:
    logger.exception("[Router] Failed to load cc_replay router")
