"""
Fund Portfolio Router — Sprint 94
===================================
REST API for per-fund holdings, trade log, performance history,
and cross-fund comparison.  All data served from fund_persistence SQLite.

Endpoints:
  GET /api/v7/funds                          — list all 3 funds with latest metrics
