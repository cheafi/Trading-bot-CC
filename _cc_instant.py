...
def _stale_fund_lab_bytes(reason: str) -> bytes:
    ...
    console = {
        ...
        "allocator_truth_strip": {
            ...
            "current_research_fit": "None",
            "max_capital_allowed": "0%",
            "live_eligible_capital_pct": 0,
            "theoretical_model_band": "0%",
            "why_not_more": [
        ...
        "funds_mode": {
            ...
            "live_allocation_eligible": 0,
            "allocation_authority": "none",
            "live_trades_count": 0,
            "blockers": ["broker offline", "portfolio not synced", "no live validation"],
            "allocation_execution_locked": True,
            "guardrail": "Funds tab is not an allocation instruction.",
        },
        "funds_first_screen": {
            "now": "Research only · no live allocation",
            "why": "broker offline + portfolio not synced + no live validation",
            "core_index_posture": "hold core · no urgent action",
            "live_allocation_pct": 0,
            "live_allocation_label": "0%",
            "guardrail": "Funds tab is not an allocation instruction.",
        },
        "research_only_mode": True,
        "live_allocation_eligible": 0,
        "allocation_authority": "none",
        "guardrail": "Funds tab is not an allocation instruction.",
        "title": "Fund Research Lab",
        "research_lab_title": "Fund Research Lab",
        "investable_now": {
            "regime": regime_label,
